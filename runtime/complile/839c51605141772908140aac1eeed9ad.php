	  		...
	  		<form action="<?php echo \core\basic\Url::get('/admin/Company/mod');?>" method="post">
	  			...
	  			<div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="name" value="<?php echo @$this->getVar('companys')->name;?>" placeholder=""  class="layui-input">
                     </div>
                </div>
	  			...
	  			<div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="address" value="<?php echo @$this->getVar('companys')->address;?>" placeholder=""  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="postcode" value="<?php echo @$this->getVar('companys')->postcode;?>" placeholder=""  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="contact" value="<?php echo @$this->getVar('companys')->contact;?>" placeholder=""  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="mobile" value="<?php echo @$this->getVar('companys')->mobile;?>" placeholder=""  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="phone" value="<?php echo @$this->getVar('companys')->phone;?>" placeholder=""  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="fax" value="<?php echo @$this->getVar('companys')->fax;?>" placeholder=""  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="email" value="<?php echo @$this->getVar('companys')->email;?>" placeholder=""  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="qq" value="<?php echo @$this->getVar('companys')->qq;?>" placeholder=""  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-inline">
                     	<input type="text" name="weixin" id="weixin" value="<?php echo @$this->getVar('companys')->weixin;?>" placeholder=""  class="layui-input">
                     </div>
                ...
                <!--<div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="blicense" value="<?php echo @$this->getVar('companys')->blicense;?>" placeholder=""  class="layui-input">
                     </div>
                </div>-->
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="other" value="<?php echo @$this->getVar('companys')->other;?>" placeholder=""  class="layui-input">
                     </div>
                </div>
...
<?php return array (
  0 => 'D:/phpstudy_pro/WWW/new/apps/admin/view/default/common/head.html',
  1 => 'D:/phpstudy_pro/WWW/new/apps/admin/view/default/common/foot.html',
); ?>