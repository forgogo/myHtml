...
<nav class="navbar navbar-default met-nav" role="navigation">
  ...
  <div class="container">
    ...
    <div>
      <ul class="nav navbar-nav navbar-right navlist listItem">
        {pboot:nav num=1 parent=0} {pboot:3nav num=15 parent=1}
        <li class="dropdown margin-right-20 listItem">
    ...
    <div class="row">
      <div class="service-box">
        <ul class="service-wraper">
          ...
          <li class="service-slide1"> <a href="[nav:link]" title="[nav:name]"> <b> <img src="{pboot:sitedomain}/pc/picture/fu.png"> <img class="icon" src="[nav:ico]"> </b>
            <h3> [nav:name] </h3>
            <p> [nav:description] </p>
            </a> </li>
          {/pboot:nav}
...
<script src="{pboot:sitedomain}/pc/js/index.js"></script>
  ...
  1 => 'D:/phpstudy_pro/WWW/new/template/default/comm/foot.html',
); ?>