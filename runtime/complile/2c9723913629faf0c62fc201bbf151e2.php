...
<nav class="navbar navbar-default met-nav " role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <div class="vertical-align-middle"> <img src="{pboot:sitelogo}" alt="{pboot:companyname} " title="{pboot:companyname}" /> </div>
      </a>
      <h2 class='hide'> </h2>
    </div>
    <div class="collapse navbar-collapse navbar-collapse-toolbar" id="navbar-default-collapse">
      ...
      <ul class="nav navbar-nav navbar-right navlist">
        ...
        <li class="dropdown margin-right-20"> <a data-toggle="dropdown" data-hover="dropdown" aria-expanded="false" class="dropdown-toggle link  " href="[nav:link]"> [nav:name]
          {pboot:if([nav:soncount]>0)} <span class="caret"> </span> {/pboot:if} </a> {pboot:if([nav:soncount]>0)}
...
{pboot:position separator=>> indextext=首页}
        ...
        <div class="met-product">
          <ul class="blocks-2 blocks-sm-2 blocks-md-3 blocks-xlg-3  met-page-ajax met-grid" id="met-grid" data-scale='0.8'>
            {pboot:list num=12 order=sorting}
            <li class=" shown">
              <div class="widget widget-shadow">
                <figure class="widget-header cover"> <a href="[list:link]"​ title="[list:title]"> <img class="cover-image" src="[list:ico]" alt="[list:title]" style='max-height:200px;'> </a> </figure>
                <h4 class="widget-title"> <a href="[list:link]"​ title="[list:title]"> [list:title] </a> </h4>
              </div>
            </li>
            {/pboot:list}
          </ul>
...
<script src="{pboot:sitedomain}/pc/js/index.js"></script>
  ...
  0 => 'D:/phpstudy_pro/WWW/new/template/default/comm/head.html',
  1 => 'D:/phpstudy_pro/WWW/new/template/default/comm/list_banner.html',
  2 => 'D:/phpstudy_pro/WWW/new/template/default/comm/position.html',
  3 => 'D:/phpstudy_pro/WWW/new/template/default/comm/page.html',
  4 => 'D:/phpstudy_pro/WWW/new/template/default/comm/left.html',
  5 => 'D:/phpstudy_pro/WWW/new/template/default/comm/foot.html',
); ?>